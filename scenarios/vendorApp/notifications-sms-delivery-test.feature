@notifications @nc7 @linear-id-315 @sms-channel
Feature: NC-7 Notification SMS delivery
  As an APEX user
  ...
  @sms-channel @positive @security @smoke
  ...
  @sms-channel @positive @informational
