@notifications @notification-center @expiry-reminder
Feature: Payment Request Expiry Reminder
  ...
  # Source: Linear ID-313 [NC-5] Payment Request Expiry Reminder; PRD Notification Center Section 2.

  @expiry-reminder @duplicate @negative
  ...
  @expiry-reminder @lifecycle @negative
